<%@ Page Title="Движение оборудования" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeviceMoving.aspx.cs" Inherits="WebSklad2.Forms.DeviceMoving" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="container">
        <div class="row"><h2>Движение оборудования по складу</h2></div>
    </div>
    <div class="row">
        <div class="col-3">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DataConnection %>" SelectCommand="SELECT DISTINCT [Name] FROM [Device_type]"></asp:SqlDataSource>
        </div>
        <div class="col-3">
        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <asp:Button ID="Button1" runat="server" Text="Поиск" class="btn btn-light" OnClick="Button1_Click"/>
            </div>
        </div>
    </div>
