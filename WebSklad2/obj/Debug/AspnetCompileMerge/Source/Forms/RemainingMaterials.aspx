...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
        <div class="col-3">
            <label for="TextBox1">Остаток на дату:</label>
            <asp:TextBox ID="TextBox1" autocomplete="off" runat="server" data-range="false" class="datepicker-here" Width =" 200"></asp:TextBox>
           </div>
        ...
        <div class="row">
                ...
                <asp:Button ID="Button5" runat="server" Text="Сформировать" class="btn btn-lght" OnClick="Button5_Click"/>
            </div>
        </div>
    </div>
    ...
    <div class="card" id="report">
        ...
        <div class="card-body">
                 <div class ="py-3 text-left"> <asp:GridView ID="GridView1" runat="server"  class="table table-bordered table-sm" OnRowDataBound="GridView1_RowDataBound"></asp:GridView>
