<%@ Page  Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebSklad2._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p>
                Отчет по поступлению материалов на склад.
            </p>
            <p>
                <a runat="server" class="btn btn-light" href="~/Forms/MaterialsIncomeByDate">Перейти &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
